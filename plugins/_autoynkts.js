...
if (m.isBaileys) return
    ...
    // ketika ditag 
    try {
    let TandaTanya = /^(bot|anj|alay|lah|ha?|apa|ikut|banh|sv|siapa|gblk|iy)$/i.test(m.text)
...
title: '「 🤨 」',
body: wm,
sourceUrl: 'https://wa.me/6282195322106', thumbnail: await( await fetch(pp)).buffer()
